...
class MainViewController: UIViewController {
    ...
    private func displayWeatherView(for condition: WeatherCondition) {
        ...
        let newWeatherView: UIView
        switch condition {
        case .clear:
            newWeatherView = ClearWeatherView()
        case .rain:
            newWeatherView = RainWeatherView()
        case .thunderstorm:
            newWeatherView = ThunderstormWeatherView()
        case .fog:
            newWeatherView = FogWeatherView()
        }
